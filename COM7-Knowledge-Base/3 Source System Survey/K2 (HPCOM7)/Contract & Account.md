...
"สัญญานี้คือเครื่องอะไร" ได้เลย ไม่ต้องอ้อมผ่าน `QUOTATION` ดู [[Business Rules]] ข้อ 5
...
## `CONTRACT` — 288,205 แถว · 30 คอลัมน์
...
> **นั่นคือ device registry `DEV-01` ที่ Gap Review ระบุว่า "ขาด"** ดู [[Business Rules]] ข้อ 7
...
`MT_STATUS` มี 61 สถานะ ใช้ร่วมกันทั้งใบคำขอ สัญญา การชำระ และการทวงถาม — ดู [[Master & Setup]]

---

## `APPLICATION` — 410,306 แถว · 27 คอลัมน์
...
## `QUOTATION` — 801,188 แถว · 107 คอลัมน์
...
**`UTM_CODE` อยู่ที่นี่** (`MT_UTM` 2,496 แถว) → ตามรอย campaign ที่พาลูกค้ามาได้ เชื่อมกับงาน CRM ที่ [[../ITEC|ITEC]] ทำอยู่ `[อนุมาน]`
...
## `PRODUCT` — 403,758 แถว · 95 คอลัมน์
...
## `CreditScrolling_Logs_Contract` — 239,757,512 แถว
...
[[K2 Overview]] · [[Query Cookbook]] · [[Business Rules]] · [[Payment & Invoice]] · [[Collection & OD]] · [[Master & Setup]] · [[Customer & Address]]
