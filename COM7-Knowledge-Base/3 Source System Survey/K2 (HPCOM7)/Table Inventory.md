...
**`GUARANTOR` คือผู้ค้ำตัวจริง 12,629 คน แต่มี `CONTRACT_ID` แค่ 1,121 สัญญา** ที่เหลือผูกกับ `APP_ID` → [[Business Rules]] ข้อ 6
...
รายละเอียด → [[Customer & Address]]

---

## 2 · ใบเสนอราคา / ใบคำขอ — 12 ตาราง
...
> **ต้องไปดูตารางนี้ก่อนเริ่ม mapping ใหม่** เชื่อมกับ [[../../5 Sub-Projects/K2 + ITOS Integration|K2 + ITOS Integration]]

รายละเอียด → [[Contract & Account]]
...
รายละเอียด → [[Payment & Invoice]]

---

## 5 · ติดตามหนี้ — 2 ตาราง
...
## 7 · Reporting / Interface — 53 ตาราง
...
ค่าจริงของ master ที่ใช้บ่อย → [[Master & Setup]]
...
[[K2 Overview]] · [[Query Cookbook]] · [[Business Rules]] · [[Customer & Address]] · [[Contract & Account]] · [[Payment & Invoice]] · [[Collection & OD]] · [[Master & Setup]]
