...
ค่าในหน้านี้ไม่ใช่ PII จึงเก็บค่าจริงได้ · ใช้เป็น lookup ตอนอ่านผลคิวรี่จาก [[Query Cookbook]]

---

## `MT_STATUS` — 61 สถานะ ใช้ร่วมกันทั้งระบบ
...
### `MT_INSTALLMENT` — จำนวนงวดที่เปิดใช้
...
### `SETUP_PARTNER` — ร้านที่ขายเครื่อง
...
**~1,900 สาขา** เป็นตัวเลขที่ยืนยันจากฐานจริง — ต่างจาก "1,000 สาขา" ที่ [[../../README|README]] เตือนว่าเป็นตัวเลขที่ AI แต่งขึ้นในเวอร์ชันแรก **ตัวเลขนี้มาจาก `SETUP_PARTNER_BRANCH` และเป็นจำนวนสาขาในระบบ K2 ไม่ใช่จำนวนสาขาทั้งเครือ**
...
| ตาราง | แถว | คืออะไร |
|---|---:|---|
| **`FeeControl`** | **3** | **อัตราค่าธรรมเนียม** — late fee 100 · track fee 50 · discount 50 · มี `EffectiveDate`/`ExpiryDate` → [[Fee Policy]] |
...
→ ตาม PDPA มาตรา 26 นี่คือข้อมูลอ่อนไหวชั้นสูงที่ต้องมีฐานทางกฎหมายแยกจาก consent ทั่วไป `[อนุมาน]` — ควรยกเป็นประเด็นถาม legal ดู [[../../4 SSOT & Customer 360/Consent & PDPA|Consent & PDPA]]

---

## ข้อสังเกตเรื่องการตั้งชื่อ
...
[[K2 Overview]] · [[Query Cookbook]] · [[Table Inventory]] · [[Customer & Address]] · [[Contract & Account]]
