...
## `COLLECTION_OD` — 15,653,423 แถว · 33 คอลัมน์
...
→ **ถ้าจะดึงรายชื่อลูกหนี้ตามขั้น OD ต้องเลือกวัน snapshot ให้ถูก** ดู [[Termination Letter Mapping]]
...
### กลุ่มลูกค้า — `PRODUCT_TYPE` (snapshot 2026-08-26)
...
## `COLLECTION_OD_ASSIGNMENT` — 98,477 แถว
...
> **ถ้าจะทำ address standardization ให้ดึงจาก `ADDRESS` ไม่ใช่จากตารางนี้** ดู [[Customer & Address]]

เช่นเดียวกัน คำสรุปเดิมว่า "K2 ไม่มี `CREATE_DATE` จึงทำ incremental ไม่ได้" มาจากดูตารางนี้ตารางเดียว — ตารางต้นทางมี timestamp ครบ ดู [[K2 Overview]]

---

## `CONTACT_DEBT_COLLECTION` — 3,458,409 แถว · 14 คอลัมน์
...
→ **อย่าใช้เป็นยอดค้าง ณ วันนี้** ตารางเต็มและผลตรวจ → [[Fee Policy]]

---

## Master ของงานติดตามหนี้

### `MT_COLLECTION` — ผลการติดตาม 11 ค่า
...
### `MT_DebtContactStatus` — 15 สถานะ · สร้าง 2023-06-29
...
เป็นข้อมูลผลงานพนักงาน ไม่ใช่ข้อมูลลูกค้า → สิทธิ์เข้าถึงต้องคิดแยก ดู [[Business Rules]] ข้อ 8
...
**สองระบบมีงานทวงถามซ้อนกัน** และยังไม่มีหลักฐานว่าสัญญาชุดไหนอยู่ระบบไหน หรือซ้ำกันไหม — คำถามนี้ยังเปิดอยู่ ดู [[../../5 Sub-Projects/K2 + ITOS Integration|K2 + ITOS Integration]]
...
[[K2 Overview]] · [[Query Cookbook]] · [[Business Rules]] · [[Fee Policy]] · [[OD6 Selection Logic]] · [[Termination Letter Mapping]] · [[Contract & Account]] · [[Payment & Invoice]] · [[../UFUND (K2 & ITOS)|UFUND (K2 & ITOS)]] · [[../../5 Sub-Projects/K2 + ITOS Integration|K2 + ITOS Integration]]
