...
## `PERSON` — ตารางบุคคล 404,749 แถว · 190 คอลัมน์
...
### ปัญหาลูกค้าซ้ำ วัดออกมาเป็นตัวเลขได้แล้ว
...
เชื่อมกับ [[../../4 SSOT & Customer 360/Customer Identity|Customer Identity]] · วิธีคิวรี่อยู่ที่ [[Query Cookbook]] ข้อ 10

### ข้อมูลอ่อนไหวที่อยู่ใน `PERSON`
...
> คนเหล่านี้ไม่ได้ทำสัญญากับ COM7 — ประเด็นเดียวกับที่ ITOS เจอ ดู [[../UFUND (K2 & ITOS)|UFUND (K2 & ITOS)]]
...
→ **K2 มีร่องรอย consent ในฐาน** ซึ่งเป็นมากกว่าที่ [[../../4 SSOT & Customer 360/Consent & PDPA|Consent & PDPA]] บันทึกไว้ตอนนี้ ควรตรวจว่า `CONFIRM_PDPA` มีค่าจริงกี่แถวก่อนสรุป

**`PASSWORD`** — มีคอลัมน์ชื่อนี้ใน `PERSON` ยังไม่ได้ตรวจว่า hash หรือ plaintext

---

## `ADDRESS` — ที่อยู่ 403,283 แถว · 101 คอลัมน์
...
> รายละเอียดและข้อสรุปที่ใช้ได้ → [[Business Rules]] ข้อ 4
...
### กับดัก: `_PROVINCE` เป็นข้อความที่เก็บตัวเลข
...
## `PROSPECT_CUSTOMER` — ผู้สนใจก่อนเป็นลูกค้า 800,283 แถว · 132 คอลัมน์
...
[[K2 Overview]] · [[Query Cookbook]] · [[Business Rules]] · [[Contract & Account]] · [[Master & Setup]] · [[../../4 SSOT & Customer 360/Customer Identity|Customer Identity]] · [[../../4 SSOT & Customer 360/Consent & PDPA|Consent & PDPA]]
