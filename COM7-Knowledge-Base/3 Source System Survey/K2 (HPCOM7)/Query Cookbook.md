...
> อย่า export ลงไฟล์ที่ commit เข้า git · ดู [[../../4 SSOT & Customer 360/Consent & PDPA|Consent & PDPA]]
...
3. `PERSON` **ไม่ใช่ทะเบียนลูกค้าที่ไม่ซ้ำ** — คนเดียวมีได้หลาย `PERSON_ID` ค้นด้วย `TAX_ID` ถ้าต้องการทุกใบของคนเดียวกัน ดู [[Customer & Address]]

---

## 1 · ที่อยู่ทุกชุดของลูกค้า จาก `PERSON_ID`
...
## 2 · ที่อยู่ปัจจุบันเป็นบรรทัดเดียว
...
## 4 · ค้นจาก **เลขบัตรประชาชน** แล้วดึงทุกใบของคนเดียวกัน
...
## 5 · สัญญาทั้งหมดของลูกค้า + ยอดค้างล่าสุด
...
## 8 · จากเลขสัญญา → ลูกค้า + ที่อยู่ + เครื่องที่ซื้อ
...
## 10 · หาลูกค้าที่ซ้ำ (เลขบัตรเดียวหลาย `PERSON_ID`)
...
→ นี่คือหลักฐานตรงสำหรับ [[../../4 SSOT & Customer 360/Customer Identity|Customer Identity]] — ปัญหาลูกค้าซ้ำ **เกิดในระบบเดียวด้วย** ไม่ใช่แค่ข้ามระบบ

---

## 11 · งวดไหนจ่ายแล้ว งวดไหนยังค้าง
...
**`DUEDATE` มีแค่วันที่ 1 กับ 16 เท่านั้น** ทั้ง 5.8 ล้านแถว — ดู [[Business Rules]] ข้อ 1–2

---

## 12 · สัญญานี้คือเครื่องอะไร (ทางลัด)
...
ที่เหลือผูกกับใบคำขอเพราะผู้ค้ำถูกกรอกก่อนสัญญาเกิด ดู [[Business Rules]] ข้อ 6

---

## 14 · คัดรายชื่อทำหนังสือบอกเลิกสัญญา (Overdue 6)
...
ช่องอื่นๆ ที่ต้องใช้ในหนังสือ (ที่อยู่ · จำนวนงวดค้าง · ยอดเป็นตัวอักษร) → [[Termination Letter Mapping]]
...
[[K2 Overview]] · [[Business Rules]] · [[Termination Letter Mapping]] · [[Customer & Address]] · [[Contract & Account]] · [[Payment & Invoice]] · [[Collection & OD]] · [[Master & Setup]] · [[Table Inventory]]
