...
> นี่คือ**มาตรฐาน** ไม่ใช่โปรเจกต์ · โปรเจกต์ที่นำมาตรฐานนี้ไปทำจริงอยู่ที่ [[../2 AWS Data Lake/Status & Phases|AWS Data Lake]]
...
## 2 · Operation — แยกตามประเภทธุรกิจ
...
> แถว Finance ตรงกับธุรกิจสินเชื่อของ [[../3 Source System Survey/UFUND (K2 & ITOS)|TFF/UFUND]] และ **BOT Compliance เป็นกฎเกณฑ์อีกชุดนอกเหนือจาก PDPA** — ยืนยันได้จาก field `CUST_BOTCUSTCODE`, `CUST_BOTCODE`, `CUST_BOTINSTCODE` ใน ITOS

---

## 3 · Customers

### หลักการ consent (สไลด์ 6)
...
⚠️ ข้อนี้ขัดกับสไลด์ 8 ที่เสนอให้ CRM ครอบคลุมทั้งเครือ → [[../4 SSOT & Customer 360/Consent & PDPA|Consent & PDPA]]

### สิ่งที่ CRM ต้องมี (สไลด์ 7)
...
> "trade-in" ถูกระบุระดับ framework แต่ระบบที่ถือข้อมูลนี้ ([[../3 Source System Survey/Other Systems|Tech Trade]]) ไม่อยู่ใน project brief เดิม

### CRM Data — Current vs Propose (สไลด์ 8)
...
รายละเอียด: [[../3 Source System Survey/Customer Platforms (CRM, 7Club, Braze)|CRM, 7Club, Braze]]

### Customer Tracking (สไลด์ 9–11)
...
## 4–6 · ขอบเขตที่เดคระบุแต่ไม่ลงรายละเอียด

- **Clean & Unified Data** → งานจริงอยู่ที่ [[../4 SSOT & Customer 360/Data Standardization & Quality|Data Standardization & Quality]]
- **Audit & Risk Management** → Gap Review `ARC-11` ระบุว่ายังไม่ลงรายละเอียดถึงระดับ lineage
- **Regulation & Compliance** → [[../4 SSOT & Customer 360/Consent & PDPA|Consent & PDPA]]

---

## อ่านต่อ

[[Objectives & SSOT Roadmap]] · [[../2 AWS Data Lake/Status & Phases|AWS Data Lake]] · [[../4 SSOT & Customer 360/Consent & PDPA|Consent & PDPA]]
